...
<br>
<button id="saveButton">save to Firebase</button>
<br>
<!-- <div  style="width:320px;color:red">xDDDDDD</div> -->
<input id="results">
<script>
  ...
  <script type="module">
    ...
    const firebaseConfig = {
      apiKey: "AIzaSyDoK1bg8i4gVXToL3g2s2OL2IP0vnoKrSs",
      authDomain: "esp32cam-gharbia-reader.firebaseapp.com",
      databaseURL: "https://esp32cam-gharbia-reader-default-rtdb.firebaseio.com",
      projectId: "esp32cam-gharbia-reader",
      storageBucket: "esp32cam-gharbia-reader.appspot.com",
      messagingSenderId: "670339332269",
      appId: "1:670339332269:web:345eb157837220f1a6ee24",
      measurementId: "G-TV7SCHR9EF"
    };
    ...
    document.getElementById("saveButton").addEventListener('click', function(e){
        set(ref(db, 'user/' + document.getElementById("results").value),
        {
